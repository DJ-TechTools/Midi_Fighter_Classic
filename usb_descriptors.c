...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor =
{
    ...
    .VendorID               = 0x2580,  // VID assigned to DJ Tech tools
    .ProductID              = 0x0001,  // Midifighter Classic PID
//     .VendorID               = 0x17CC,  // VID assigned to DJ Tech tools
//     .ProductID              = 0xBAFF,  // Midifighter Classic PID
...
const USB_Descriptor_String_t PROGMEM ProductString =
{
    .Header                 = { .Size = USB_STRING_LEN(20),
                                .Type = DTYPE_String },
    .UnicodeString          = L"Midi Fighter Classic"	
};
